...
I began getting used with the proces of adding events and actions to the scene so much so that I was able to add the orange to the next level (including it being deleted when the player interacts with it and it increasing the variable that is holding the amount of fruits collected) without looking at any tutorials. 
