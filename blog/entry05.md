...
## Skills
The [skills](https://hstatsep.github.io/students/#skills) that I have practiced throughout the last few weeks have been *creativity* and *logical reasoning*. I know that I am making this game for others entertainment so I have to try to make the game as interesting as I can. In order to do that I need to be creative of what I'm adding to the game. I originally was just going to add the fruits for the player to collect, but to make the game more enjoyable, I made it so that the physics changed when the fruits were collected. To do all of that, I needed to process many different conditionals to make it so that if something happened, something else would occur. In the examples shown above, it was that if the fruits were collected, then the physics changed or that if the player touched the enemy, they would die, and if the player would collect all the fruits, they would win. 
